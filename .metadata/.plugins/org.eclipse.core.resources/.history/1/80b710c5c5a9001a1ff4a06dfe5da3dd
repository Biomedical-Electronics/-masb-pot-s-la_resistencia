...
void Sampling_Period_CV(void){
	// Usamos el timer 3 para calcular el tiempo entre muestras de la voltametria ciclica
	HAL_TIM_Base_DeInit(&htim3); // desinicializar el timer
	  ...
	  htim3.Init.Period = cvConfiguration.eStep/cvConfiguration.scanRate; // cambiamos el periodo al de la voltametria ciclica
	...
	HAL_TIM_Base_Init(&htim3); // inicializar el timer
	HAL_TIM_Base_Start_IT(&htim3); // volvemos a iniciar el funcionamiento del timer
}
